document.getElementById("contactForm").addEventListener("submit", (e) => {
  ...
  const emailReceiver = 'aditiasaputra180897@gmail.com'
    ...
    a.href = `mailto:${emailReceiver}?subject=${subject.toUpperCase()}&body=Hello, my name is ${name}, message: ${message}. If there is a problem please call this number ${phone}, Thanks.`;
    a.click();
  });